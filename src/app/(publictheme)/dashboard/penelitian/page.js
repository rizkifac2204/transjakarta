...
import { publicGetPenelitian } from "@/libs/publik/penelitian";
...
export const metadata = {
  title: "Riwayat Permohonan Penelitian",
};
...
async function DashboardPublikPenelitianPage() {
  const data = await publicGetPenelitian();

  return (
    <div className="user-dashboard-box bg-light">
      <div className="dashHeader p-xl-5 p-4 pb-xl-0 pb-0 py-lg-0 py-5">
        <h2 className="fw-medium mb-0">Riwayat Permohonan Penelitian</h2>
      </div>
          ...
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="card rounded-3 shadow-sm">
              <div className="card-header px-4 py-3">
                <h4 className="m-0">List Permohonan Penelitian</h4>
              </div>
                          ...
                          <div className="d-flex justify-content-start gap-5 flex-wrap">
                            <div>
                              ...
                              <div className="text-md mt-2">
                                {item?._count?.jawaban_penelitian} Jawaban
                              </div>
...
export default DashboardPublikPenelitianPage;
