...
import FormKeberatanPublik from "./_FormKeberatanPublik";
import { getSession } from "@/libs/auth-public";

async function PublikFormPengajuanKeberatan() {
          ...
          <div className="row justify-content-between g-4">
            <div className="col-lg-7 col-md-12">
              <div className="contactForm pe-xl-5 pe-lg-4">
                <FormKeberatanPublik session={session} />
              </div>
            </div>
...
export default PublikFormPengajuanKeberatan;
