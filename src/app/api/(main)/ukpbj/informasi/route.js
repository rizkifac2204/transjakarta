...
import { createUI } from "@/libs/ukpbj-informasi-withsub";
...
export async function POST(request) {
  ...
  try {
    ...
    const header_sub_sub_id = formData.get("header_sub_sub_id");
    ...
    const inserted = await createUI({
      header_sub_sub_id: header_sub_sub_id ? parseInt(header_sub_sub_id) : null,
      label,
      link: link ? link : null,
