    ...
    >
      <Tooltip content="Detail" placement="top" arrow animation="shift-away">
        <Link
          ...
          href={`/admin/permohonan/${encodeId(rowData.id)}`}
        >
      ...
      <Tooltip content="Edit" placement="top" arrow animation="shift-away">
        <Link
          className="action-btn"
          href={`/admin/permohonan/${encodeId(rowData.id)}/edit`}
        >
    ...
    <Card
      ...
      headerslot={
        <div className="flex flex-col md:flex-row gap-2">
          ...
          />
          <ButtonExport data={safeData} fileName="Permohonan-Informasi" />
        </div>
      }
    >
...
export default TablePermohonan;
