    ...
    <>
      ...
      >
        <div className={`w-full space-y-2 ${isModal ? "border-b pb-2" : ""}`}>
          ...
          />
          <DetailRow label="Penguasaan Data" value={data?.penguasaan} />
          <DetailRow label="Bentuk Fisik Data" value={data?.bentuk_fisik} />
          <DetailRow label="Biaya" value={`Rp. ${data?.biaya || "-"}`} />
          <DetailRow
            label="Jangka Waktu"
            value={`${data?.jangka_waktu || "-"} Hari`}
          />
          <DetailRow label="Keterangan Penghitaman" value={data?.penghitaman} />
          <DetailRow label="Dasar Pengecualian" value={data?.pengecualian} />
          <DetailRow label="Pasal" value={data?.pasal} />
          <DetailRow label="Konsekuensi" value={data?.konsekuensi} />
        ...
        <div className="flex gap-2 flex-col md:flex-row">
            ...
            <FilePreview
              fileUrl={
                data?.file_surat_pemberitahuan
                  ? `/api/services/file/uploads/${PATH_UPLOAD.jawaban.pemberitahuan}/${data?.file_surat_pemberitahuan}`
                  : null
              }
          ...
          <div className="w-full mx-auto">
            <FilePreview
              fileUrl={
                data?.file_informasi
                  ? `/api/services/file/uploads/${PATH_UPLOAD.jawaban.informasi}/${data?.file_informasi}`
                  : null
              }
