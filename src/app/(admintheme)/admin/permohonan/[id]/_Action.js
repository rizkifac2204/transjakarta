...
function ActionPermohonanDetail({ id }) {
    ...
    >
      ...
      >
        <Link
          ...
          href={`/admin/permohonan/${encodeId(id)}/jawaban/add`}
          scroll={false}
        >
      ...
      <Tooltip content="Edit" placement="top" arrow animation="shift-away">
        <Link
          className="action-btn"
          href={`/admin/permohonan/${encodeId(id)}/edit`}
        >
...
export default ActionPermohonanDetail;
