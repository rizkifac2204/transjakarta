...
function FormAddPeraturan({ headers }) {
  ...
  async function onSubmit(data) {
    ...
    if (noLink && noFile) {
      toast.error("Minimal isi Link atau Upload File peraturan.");
      return;
    }
    ...
    try {
      ...
      const res = await axios.post("/api/peraturan", formData, {
        headers: {
...
export default FormAddPeraturan;
