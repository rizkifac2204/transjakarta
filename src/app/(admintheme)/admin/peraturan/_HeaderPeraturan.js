...
function HeaderPeraturan({ data }) {
  ...
  const handleDelete = async (id) => {
    ...
    setDeletingRowId(id);
    try {
      const res = await axios.delete(`/api/peraturan/header/${id}`);
    ...
    <Card
      ...
      headerslot={
        <div className="flex gap-2">
          <Link
            href="/admin/peraturan/header/add"
            scroll={false}
                  ...
                  label={
                    <div className="flex items-center">
                      ...
                      <Link
                        ...
                        href={`/admin/peraturan/header/${encodeId(
                          item.id
                        )}/edit`}
                        scroll={false}
                      >
...
export default HeaderPeraturan;
