...
function HeaderDip({ kategori, data }) {
  ...
  const handleDelete = async (id) => {
    ...
    setDeletingRowId(id);
    try {
      const res = await axios.delete(`/api/dip/${kategori}/header/${id}`);
    ...
    <Card
      ...
      headerslot={
        <div className="flex gap-2">
          <Link
            href={`/admin/dip/${kategori}/header/add`}
            scroll={false}
                  ...
                  label={
                    <div className="flex items-center">
                      ...
                      <Link
                        ...
                        href={`/admin/dip/${kategori}/header/${encodeId(
                          item.id
                        )}/edit`}
                        scroll={false}
                      >
