...
function FormAddDip({ kategori, headers }) {
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      const res = await axios.post(`/api/dip/${kategori}`, formData, {
        headers: {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-3">
        <Select
          ...
          placeholder={!headers ? "Memuat data..." : "Pilih Header DIP"}
          disabled={!headers}
          {...register("header_id")}
        />
        ...
        <Textinput
          ...
          name="label"
          id="label"
          placeholder="Masukan Judul atau Nama DIP"
        ...
        <Textinput
          ...
          name="link"
          id="link"
          placeholder="Masukan Link Lokasi File DIP"
          {...register("link")}
        />
        ...
        <Fileinputcontroller
          name="file"
          id="file"
          label="Upload File DIP"
          placeholder="Pilih gambar/file DIP"
          control={control}
          error={errors.file}
          preview
          badge
