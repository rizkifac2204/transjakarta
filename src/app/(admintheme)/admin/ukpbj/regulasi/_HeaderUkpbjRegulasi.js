...
function HeaderUkpbjRegulasi({ data }) {
  ...
  const handleDelete = async (id) => {
    ...
    setDeletingRowId(id);
    try {
      const res = await axios.delete(`/api/ukpbj/regulasi/header/${id}`);
    ...
    <Card
      ...
      headerslot={
        <div className="flex gap-2">
          <Link
            href="/admin/ukpbj/regulasi/header/add"
            scroll={false}
                  ...
                  label={
                    <div className="flex items-center">
                      ...
                      <Link
                        ...
                        href={`/admin/ukpbj/regulasi/header/${encodeId(
                          item.id
                        )}/edit`}
                        scroll={false}
                      >
...
export default HeaderUkpbjRegulasi;
