...
function FormAddUkpbjRegulasi({ headers }) {
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      const res = await axios.post("/api/ukpbj/regulasi", formData, {
        headers: {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-3">
        <Select
          ...
          placeholder={!headers ? "Memuat data..." : "Pilih Header"}
          disabled={!headers}
          {...register("header_id")}
        />
        ...
        <Textinput
          ...
          name="label"
          id="label"
          placeholder="Masukan Judul atau Nama Regulasi"
        ...
        <Textinput
          ...
          name="link"
          id="link"
          placeholder="Masukan Link Lokasi File Regulasi"
          {...register("link")}
        />
        ...
        <Fileinputcontroller
          name="file"
          id="file"
          label="Upload File Regulasi"
          placeholder="Pilih gambar/file Regulasi"
          control={control}
          error={errors.file}
          preview
          badge
...
export default FormAddUkpbjRegulasi;
